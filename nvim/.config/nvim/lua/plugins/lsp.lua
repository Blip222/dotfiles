return {
  ...
  config = function()
    ...
    require('mason-tool-installer').setup { ensure_installed = ensure_installed }
        ...
        vim.list_extend(ensure_installed, {
        'stylua', 
        'shellcheck', -- Add this for shell linting
        'shfmt',      -- Add this for shell formatting
    })

    local ensure_installed = vim.tbl_keys(servers or {})
vim.list_extend(ensure_installed, {
  'stylua', 
  'prettier', -- Add this for JS/TS formatting
  'eslint_d', -- A faster version of eslint for linting
})
